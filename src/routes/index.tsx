  ...
  return (
    <div className={`relative h-screen bg-[#080912] text-foreground flex overflow-hidden ${isDarkMode ? "dark" : ""}`}>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Top Header Bar */}
        <header className="relative z-40 flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4 border-b border-white/5 bg-[#080912]/85 backdrop-blur-xl shrink-0 select-none">
