  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="mx-auto max-w-5xl px-6 py-12">
        ...
        <p className="mt-2 text-muted-foreground">Your bookmarked itineraries, ready when you are.</p>
        ...
        {trips.length === 0 ? (
          <div className="mt-12 rounded-3xl border border-dashed border-border p-12 text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground">Plan a trip and hit “Save” to bookmark it here.</p>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            {trips.map((t) => (
              <div key={t.id} className="rounded-2xl border border-border/60 bg-card p-5 shadow-[var(--shadow-soft)]">
                <div className="flex items-start justify-between gap-3">
                  <div>
                    ...
                    <div className="mt-1 flex items-center gap-1.5 text-xs text-muted-foreground">
                      ...
                      {t.input.startDate && t.input.endDate ? `${t.input.startDate} → ${t.input.endDate}` : new Date(t.createdAt).toLocaleDateString()}
                    </div>
                ...
                <Button onClick={() => open(t)} variant="outline" className="mt-4 w-full rounded-full">
